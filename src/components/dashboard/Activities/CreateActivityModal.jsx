// src/components/dashboard/Activities/CreateActivityModal.jsx - Without points system
...
const CreateActivityModal = ({ isOpen, onClose, onSubmit, sectionId }) => {
  const [formData, setFormData] = useState({
    ...
    dueDate: '',
    dueTime: '23:59',
    submissionType: 'physical', // 'physical' or 'online'
    submissionLink: '',
    submissionLocation: ''
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Create activity data without points
      const activityData = {
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="physical" className="ml-3 flex items-center">
