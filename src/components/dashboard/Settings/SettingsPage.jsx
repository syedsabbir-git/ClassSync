// src/components/dashboard/Settings/SettingsPage.jsx - Complete Settings page
          ...
          <div className="flex">
            ...
            <div className="flex-1 p-6">
                ...
                <div className="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-600 mt-1">{errors.submit || errors.unenroll || errors.deleteSection}</p>
                    </div>
                  </div>
                </div>
              )}
                ...
                <div>
                  ...
                  <form onSubmit={handleProfileUpdate} className="space-y-6 max-w-lg">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm text-gray-500">Email cannot be changed for security reasons</p>
                    </div>
                ...
                <div>
                  ...
                  <form onSubmit={handlePasswordChange} className="space-y-6 max-w-lg">
                    <div>
                      ...
                      {errors.currentPassword && <p className="mt-2 text-sm text-red-600 flex items-center">
                        <XCircle className="h-4 w-4 mr-1" />
                    ...
                    <div>
                      ...
                      {errors.newPassword && <p className="mt-2 text-sm text-red-600 flex items-center">
                        <XCircle className="h-4 w-4 mr-1" />
                        {errors.newPassword}
                      </p>}
                    </div>
                ...
                <div>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                    <div className="flex items-center">
                      <Bell className="h-8 w-8 text-yellow-600 mr-4" />
                      <div>
              ...
              {activeTab === 'sections' && (
                <div>
                  <div className="flex items-center mb-6">
                    <UserX className="h-6 w-6 text-gray-600 mr-3" />
                    ...
                    isCR ? (
                      <>
                        {managedSections.length === 0 ? (
                          <div className="text-center py-12 bg-gray-50 rounded-lg">
                            ...
                            <h3 className="text-lg font-medium text-gray-900 mb-2">No Managed Sections</h3>
                            <p className="text-gray-500 mb-4">You don't manage any sections yet.</p>
                            <button
                          ...
                          <div className="space-y-6">
                            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                              <div className="flex items-start">
                                ...
                                <div>
                                  ...
                                  <ul className="text-sm text-red-700 mt-2 list-disc list-inside ml-4">
                            ...
                            {managedSections.map((section) => (
                              <div key={section.id} className="border border-gray-200 rounded-lg p-6 hover:shadow-sm transition-shadow">
                                <div className="flex items-center justify-between">
                                  <div className="flex-1">
                                    <h3 className="text-lg font-medium text-gray-900">{section.departmentName}</h3>
                                    ...
                                    <div className="flex items-center space-x-4 mt-2 text-sm text-gray-500">
                                      ...
                                      <span>🗓️ Created {new Date(section.createdAt).toLocaleDateString()}</span>
                                    </div>
                                  </div>
                                  <button
                                    onClick={() => handleDeleteSection(section.id, section.departmentName)}
                                    disabled={loading}
                                    className="inline-flex items-center px-4 py-2 text-sm font-medium text-red-700 bg-red-100 rounded-lg hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                                  >
                      ...
                      <>
                        {enrolledSections.length === 0 ? (
                          <div className="text-center py-12 bg-gray-50 rounded-lg">
                            <UserX className="h-12 w-12 text-gray-400 mx-auto mb-4" />
                            <h3 className="text-lg font-medium text-gray-900 mb-2">No Enrolled Sections</h3>
                            <p className="text-gray-500 mb-4">You are not enrolled in any sections yet.</p>
                            <button
                              onClick={() => onNavigate && onNavigate('overview')}
                              className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
                            >
                            ...
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                              <div className="flex items-start">
                                ...
                                <div>
                                  ...
                                  <ul className="text-sm text-blue-700 mt-2 list-disc list-inside ml-4">
                              ...
                              <div key={section.id} className="border border-gray-200 rounded-lg p-6 hover:shadow-sm transition-shadow">
                                <div className="flex items-center justify-between">
                                  <div className="flex-1">
                                    ...
                                    <p className="text-sm text-gray-500 mt-1">🗓️ Enrolled {new Date(section.createdAt).toLocaleDateString()}</p>
                                  </div>
                                  <button
