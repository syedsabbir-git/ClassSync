...
const Sidebar = ({ isOpen, isMobileOpen, onClose, currentPage, onNavigate }) => {
  ...
  const drawerClasses = `fixed inset-y-0 left-0 w-60 bg-white border-r border-gray-100 transform transition-transform duration-300 ease-in-out ${
      ...
      <div className={mobileClasses}>
        ...
        <div 
          className={`fixed inset-0 bg-gray-600 transition-opacity duration-300 ${
            isMobileOpen ? 'opacity-75' : 'opacity-0 pointer-events-none'
          }`}
          onClick={onClose}
        />
